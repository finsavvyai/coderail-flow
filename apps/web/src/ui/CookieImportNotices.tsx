...
export function ImportInstructions({ className }: ImportInstructionsProps) {
  return (
    <div className={`bg-blue-50 border border-blue-200 rounded-lg p-4 ${className || ''}`}>
      <h3 className="text-sm font-semibold text-blue-900 mb-2">How to export cookies:</h3>
      ...
      <div className="flex items-start">
        ...
        <div className="ml-3">
          ...
          <p className="text-sm text-yellow-800 mt-1">
            Cookies will be encrypted with AES-256-GCM before storage. Never share authentication
            cookies with unauthorized users.
          </p>
        </div>
      </div>
    </div>
